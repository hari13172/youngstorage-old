...
function Dashboard() {
  ...
  const rootData = queryClient.getQueriesData("root");
  return (
    <div className="dash-container">
      ...
      <div className="display">
        ...
        <p>
          ...
          temporibus et eveniet dolorum dolores maxime quod pariatur quo totam,
          magnam inventore neque nostrum eius distinctio doloremque ea, nam
          optio accusantium quia odio ratione alias perspiciatis voluptatibus.
          Repellendus cum architecto officiis eligendi hic voluptas commodi,
          mollitia repudiandae assumenda soluta unde? Modi dicta mollitia
          exercitationem officiis perferendis dolorem. Aperiam exercitationem
          autem soluta corporis non eveniet, delectus, pariatur iusto natus
          accusantium odit iste omnis. Laudantium magni iure nobis, cupiditate
          temporibus ad nemo. Adipisci minus deserunt dignissimos sed eligendi
          nulla incidunt dolores, consequuntur perspiciatis sit accusamus cumque
          deleniti, reiciendis rem, sapiente magni quod!
        </p>
