      ...
      },
      {
        ...
        >
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M11.9017 5.40075H8.4985C7.48001 5.3725 6.63081 6.17393 6.6001 7.19235V8.40915C6.63081 9.42758 7.48001 10.229 8.4985 10.2007H11.9017C12.9201 10.229 13.7694 9.42758 13.8001 8.40915V7.19235C13.7694 6.17393 12.9201 5.3725 11.9017 5.40075Z"
            //   stroke="#FBFBFB"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M18.0984 16.2009H21.5004C21.9999 16.2053 22.4808 16.011 22.837 15.6609C23.1933 15.3106 23.3959 14.8332 23.4 14.3337V7.26802C23.3959 6.76868 23.1936 6.29141 22.8375 5.94124C22.4815 5.59107 22.0009 5.39667 21.5016 5.40082H18.0984C17.599 5.39667 17.1184 5.59107 16.7624 5.94124C16.4064 6.29141 16.204 6.76868 16.2 7.26802V14.3337C16.204 14.833 16.4064 15.3102 16.7624 15.6604C17.1184 16.0106 17.599 16.205 18.0984 16.2009Z"
            //   stroke="#FBFBFB"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M18.0984 23.4007H21.5004C22.5193 23.4296 23.3692 22.628 23.4 21.6091V20.3923C23.3692 19.3739 22.52 18.5725 21.5016 18.6007H18.0984C17.0799 18.5725 16.2307 19.3739 16.2 20.3923V21.6079C16.23 22.6268 17.0794 23.4289 18.0984 23.4007Z"
            //   stroke="#FBFBFB"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
...
export default function Navhovar({ path }) {
  ...
  return (
    <div className="hov-container">
      <div className="hov-center">
        ...
        <div className="hov-icons">
          {
            paths.mainpath.map(a => (
              <div className={`cont ${path.length > 1 ? path[1] == String(a.pathname).toLocaleLowerCase() && "active" : path[0] == String(a.pathname).toLocaleLowerCase() && "active"}`} key={a.pathname}
                onClick={
                  () => ChangePath(`
                  /dashboard/${String(a.pathname).toLocaleLowerCase() == "dashboard" ?
        ...
        <div className="hov-icons">
          {
            paths.subpath.map(a => (
              <div className={`cont ${path.length > 1 ? path[1] == String(a.pathname).toLocaleLowerCase() && "active" : ""}`} key={a.pathname}
                onClick={
                  () => ChangePath(`
